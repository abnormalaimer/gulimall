...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public PageUtils queryBaseAttrPage(Map<String, Object> params, Long catelogId, String type) {
        ...
        List<AttrRespVo> respVos = records.stream().map((attrEntity) -> {
            ...
            log.info("attrEntity:{},attrRespVo:{}", attrEntity, attrRespVo);
    ...
    public void updateAttr(AttrVo attr) {
        ...
        if (attr.getAttrType() == ProductConstant.AttrEnum.ATTR_TYPE_BASE.getCode()) {
            ...
            Integer count = relationDao.selectCount(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_group_id", attr.getAttrGroupId()));
    ...
    @Override
    public PageUtils getNoARelationAttr(Long attrgroupId, Map<String, Object> params) {
